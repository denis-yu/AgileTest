...
public class GlobalVariable {
    ...
    static {
        ...
        allVariables.put('hic-qa', allVariables['default'] + ['ENV' : 'https://qa.healthinsurance.com', 'FirstName' : '', 'LastName' : '', 'Address' : '', 'Tel' : '', 'City' : '', 'AutoEmail' : '', 'i' : 0, 'screenPath' : '../Screenshots/'])
        allVariables.put('loki', allVariables['default'] + ['ENV' : 'https://loki.healthinsurance.com', 'FirstName' : '', 'LastName' : '', 'Address' : '', 'Tel' : '', 'City' : '', 'AutoEmail' : '', 'i' : 0, 'screenPath' : '../Screenshots/', 'stmPath' : '../Screenshots/mobileWeb/stm/', 'hbiPath' : '../Screenshots/mobileWeb/hbi/', 'dentalPath' : '../Screenshots/mobileWeb/dental/', 'teladocPath' : '../Screenshots/mobileWeb/teladoc/', 'HPPath' : '../Screenshots/HP/'])
        allVariables.put('medicare-staging', allVariables['default'] + ['ENV' : 'https://staging.medicare.healthinsurance.com', 'FirstName' : '', 'LastName' : '', 'Address' : '', 'Tel' : '', 'City' : '', 'AutoEmail' : '', 'i' : 0, 'screenPath' : '../Screenshots/'])
