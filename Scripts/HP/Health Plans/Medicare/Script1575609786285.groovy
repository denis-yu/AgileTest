...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'HP', ('carrierName') : 'Medicare'], 
...
for (second = 0; second < 60; second++) {
    try {
        if (selenium.isElementPresent('//a/h2[contains(text(),\'Benefits & Coverage\')]')) {
            break
        }
    }
    catch (Exception e) {
