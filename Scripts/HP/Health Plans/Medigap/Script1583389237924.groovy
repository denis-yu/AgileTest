...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'HP', ('carrierName') : 'Medigap'], FailureHandling.CONTINUE_ON_FAILURE)
...
for (second = 0; second < 60; second++) {
    try {
        if (selenium.isElementPresent('//a/h2[contains(text(),\'Plan Benefits\')]')) {
            break
        }
    }
    catch (Exception e) {
