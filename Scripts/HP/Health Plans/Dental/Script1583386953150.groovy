...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'HP', ('carrierName') : 'Dental'], FailureHandling.CONTINUE_ON_FAILURE)

int second

WebUI.openBrowser(GlobalVariable.ENV+'/dental-insurance')
...
url = selenium.getAttribute('xpath=(//a[contains(text(),\'Apply Now\')])@href')
