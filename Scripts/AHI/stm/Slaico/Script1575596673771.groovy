...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'stm', ('carrierName') : 'Salico'], 
...
WebUI.callTestCase(findTestCase('AHI/_include/census_stm'), [('zipcode') : '60602'], FailureHandling.STOP_ON_FAILURE)
