...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'hbi', ('carrierName') : 'Legion Limited Medical'], 
...
WebUI.callTestCase(findTestCase('AHI/_include/goToEnd_hbi'), [('carrier') : 'legionlimitedmedical'], FailureHandling.CONTINUE_ON_FAILURE)
