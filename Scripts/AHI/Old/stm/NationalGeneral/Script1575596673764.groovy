...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'stm',('carrierName') : 'National General'], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('AHI/_include/filter_stm'), [('carrier') : 'nationalgeneral'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('AHI/_include/goToDetail_stm'), [('carrier') : 'nationalgeneral'], FailureHandling.STOP_ON_FAILURE)
