...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'dental',('carrierName') : 'Nationwide'], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('AHI/_include/goToEnd_dental'), [('carrier') : 'nationwide'], FailureHandling.STOP_ON_FAILURE)
