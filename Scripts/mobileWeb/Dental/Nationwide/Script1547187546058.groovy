...
GlobalVariable.screenPath = (('./Screenshots/mobileWeb/dental/Nationwide/' + mydate) + '/')
GlobalVariable.i=0
...
WebUI.callTestCase(findTestCase('mobileWeb/_include/goToEnd_dental'), [('carrier') : 'nationwide'], FailureHandling.STOP_ON_FAILURE)
