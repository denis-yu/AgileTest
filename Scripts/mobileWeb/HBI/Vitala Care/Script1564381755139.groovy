...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'hbi', ('carrierName') : 'Vitala Care'], 
...
WebUI.callTestCase(findTestCase('mobileWeb/_include/census_hbi'), [('zipcode') : '90011'], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('mobileWeb/_include/goToEnd_hbi'), [('state') : 'ca', ('carrier') : 'vitalacare'], FailureHandling.CONTINUE_ON_FAILURE)
