...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'Learning Center', ('carrierName') : 'articles'], 
...
int num = selenium.getXpathCount('//div[@class=\'learningCenter--articleThumbnail\']')

println(num)

for (def index : (1..num)) {
	
    xpath = (('(//div[@class=\'learningCenter--articleThumbnail\'])[' + index) + ']/a')
