...
GlobalVariable.screenPath = (('./Screenshots/mobileWeb/stm/AdvantHealth_Plan_1/' + mydate) + '/')
GlobalVariable.i=0
...
WebUI.callTestCase(findTestCase('mobileWeb/_include/goToDetail_stm'), [('carrier') : 'advanthealth-plan-1'], FailureHandling.STOP_ON_FAILURE)
