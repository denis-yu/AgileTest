...
GlobalVariable.screenPath = (('./Screenshots/mobileWeb/stm/AdvantHealth_Plan_2/' + mydate) + '/')
GlobalVariable.i=0
...
WebUI.callTestCase(findTestCase('mobileWeb/_include/goToDetail_stm'), [('carrier') : 'advanthealth-plan-2'], FailureHandling.STOP_ON_FAILURE)
