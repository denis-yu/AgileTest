...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'Help Center', ('carrierName') : 'help members_lifeshield'],
...
WebElement el1 = driver.findElement(By.xpath("(//ul[@class='row reset amp-box-list'])[1]/li[6]/a"))
