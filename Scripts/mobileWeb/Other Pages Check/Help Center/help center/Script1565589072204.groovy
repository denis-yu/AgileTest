...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'Help Center', ('carrierName') : 'help center'],
...
helpcenter_xpath = '//ul[@class=\'footer-list footer-about\']/li/h4/a'
...
int num = selenium.getXpathCount('//div[@class=\'col-sm-4\']')

println(num)

for (def index : (1..num)) {
	
	xpath = (('(//div[@class=\'col-sm-4\'])[' + index) + ']/a')
