...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'Help Center', ('carrierName') : 'help members_coreshield'],
...
WebElement el1 = driver.findElement(By.xpath("(//ul[@class='row reset amp-box-list'])[2]/li[4]/a"))
