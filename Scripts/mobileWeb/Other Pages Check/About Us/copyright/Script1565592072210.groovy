...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'About Us', ('carrierName') : 'copyright'],
...
inthenews_xpath = '//div[@class=\'static-nav\']/ul[2]/li[4]/a'
