...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'About Us', ('carrierName') : 'our founders'],
...
inthenews_xpath = '//div[@class=\'static-nav\']/ul/li[5]/a'
