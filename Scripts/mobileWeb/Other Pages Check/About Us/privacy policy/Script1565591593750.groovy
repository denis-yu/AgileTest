...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'About Us', ('carrierName') : 'privacy policy'],
...
inthenews_xpath = '//div[@class=\'static-nav\']/ul[2]/li[1]/a'
