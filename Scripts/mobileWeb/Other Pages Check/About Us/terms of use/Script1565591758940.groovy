...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'About Us', ('carrierName') : 'terms of use'],
...
inthenews_xpath = '//div[@class=\'static-nav\']/ul[2]/li[2]/a'
