...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'About Us', ('carrierName') : 'press releases'],
...
pressreleases_xpath = '//div[@class=\'static-nav\']/ul/li[3]/a'

WebElement el = driver.findElement(By.xpath(pressreleases_xpath))
