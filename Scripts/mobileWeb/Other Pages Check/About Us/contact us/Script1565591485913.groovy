...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'About Us', ('carrierName') : 'contact us'],
...
inthenews_xpath = '//div[@class=\'static-nav\']/ul/li[6]/a'
