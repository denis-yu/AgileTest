...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'About Us', ('carrierName') : 'meet the experts'],
...
inthenews_xpath = '//div[@class=\'static-nav\']/ul/li[4]/a'
