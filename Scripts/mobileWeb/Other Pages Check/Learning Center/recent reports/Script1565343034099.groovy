...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'Learning Center', ('carrierName') : 'recent reports'], 
...
int num = selenium.getXpathCount('//div[@class=\'recent-articles\']/ul/li')

println(num)

for (def index : (1..num)) {
	
    xpath = ('//div[@class=\'recent-articles\']/ul/li[' + index + ']/div/div/a')
