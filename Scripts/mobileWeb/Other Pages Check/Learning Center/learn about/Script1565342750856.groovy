...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'Learning Center', ('carrierName') : 'learn about'], 
...
int num = selenium.getXpathCount('//div[@class=\'why-buy\']/ul/li')

println(num)

for (def index : (1..num)) {
	
    xpath = ('//div[@class=\'why-buy\']/ul/li[' + index + ']/a')
