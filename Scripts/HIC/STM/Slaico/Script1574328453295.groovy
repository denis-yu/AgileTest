...
WebUI.callTestCase(findTestCase('HIC/_include/get_hicScreenPath'), [('project') : 'HIC', ('productLine') : 'STM', ('carrierName') : 'Slaico'], 
...
WebUI.callTestCase(findTestCase('mobileWeb/_include/filter_stm'), [('carrier') : 'slaico'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('mobileWeb/_include/goToDetail_stm'), [('carrier') : 'slaico'], FailureHandling.STOP_ON_FAILURE)
