...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath('//h3[contains(text(),\'Cigna\')]/preceding::button[text()=\'Enroll\'][1]')))

driver.findElement(By.xpath('//h3[contains(text(),\'Cigna\')]/preceding::button[text()=\'Enroll\'][1]')).click()
