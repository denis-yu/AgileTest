...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath('//a[text()=\'View Part D Plans.\']')))

driver.findElement(By.xpath('//a[text()=\'View Part D Plans.\']')).click()

driver.findElement(By.xpath('//h3[contains(text(),\'SilverScript\')]/preceding::button[text()=\'Enroll\'][1]')).click()
...
driver.findElement(By.xpath("//input[@id='M-uniq18']/following-sibling::label")).click()
...
//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='root_otherGroupCoverage__title']/following::label[contains(@for, 'N-uniq')][1]")))
...
paymentsl.selectByVisibleText("Monthly Bill")
