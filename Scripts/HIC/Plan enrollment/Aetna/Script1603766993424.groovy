...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath('//h3[contains(text(),\'Aetna\')]/preceding::button[text()=\'Enroll\']')))

driver.findElement(By.xpath('//h3[contains(text(),\'Aetna\')]/preceding::button[text()=\'Enroll\']')).click()
