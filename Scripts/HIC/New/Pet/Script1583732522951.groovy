...
WebUI.callTestCase(findTestCase('HIC/_include/get_hicScreenPath'), [('project') : 'HIC', ('productLine') : 'Pet', ('carrierName') : 'Pet'], 
...
selenium.click('//*[@id=\'product-lines\']/following::div/button[contains(text(),\'Pet Insurance\')]')
