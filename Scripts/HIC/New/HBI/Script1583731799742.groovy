...
WebUI.callTestCase(findTestCase('HIC/_include/get_hicScreenPath'), [('project') : 'HIC', ('productLine') : 'HBI', ('carrierName') : 'HBI'], 
...
selenium.click('//*[@id=\'product-lines\']/following::div/button[contains(text(),\'Hospital Indemnity Plans\')]')
