...
WebUI.callTestCase(findTestCase('HIC/_include/get_hicScreenPath'), [('project') : 'HIC', ('productLine') : 'HBI', ('carrierName') : 'Fixed Cash Benefit'], 
...
WebUI.callTestCase(findTestCase('HIC/_include/stm_census'), [('zipcode') : '85364'], FailureHandling.STOP_ON_FAILURE)
