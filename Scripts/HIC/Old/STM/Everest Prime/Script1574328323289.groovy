...
WebUI.callTestCase(findTestCase('HIC/_include/get_hicScreenPath'), [('project') : 'HIC', ('productLine') : 'STM', ('carrierName') : 'Everest Prime'], 
...
WebUI.scrollToElement(findTestObject('hic/stm/quote/a_everestprime'), 10)

WebUI.click(findTestObject('hic/stm/quote/a_everestprime'))
...
WebUI.click(findTestObject('hic/stm/detail/apply_everestprime'))
...
WebUI.callTestCase(findTestCase('HIC/_include/goToEnd_stm'), [('carrier') : 'everest'], FailureHandling.STOP_ON_FAILURE)
