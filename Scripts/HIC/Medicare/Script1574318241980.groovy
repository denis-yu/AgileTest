...
WebUI.setText(findTestObject('hic/medicare/lastName'), 'testlast')

WebUI.setText(findTestObject('hic/medicare/phone'), '4524523625')

WebUI.setText(findTestObject('hic/medicare/email'), 'test.test555@suryani.cn')

WebUI.click(findTestObject('hic/medicare/continue'))
