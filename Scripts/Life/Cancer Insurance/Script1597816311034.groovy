...
WebUI.callTestCase(findTestCase('AHI/_include/get_screenPath'), [('productLine') : 'Life', ('carrierName') : 'Cancer Insurance'], 
...
selenium.click('//button[@class=\'js-navbar-toggler navbar-toggler collapsed\']')

WebUI.delay(2)

selenium.click('//div[@id=\'collapsible\']/ul/li[3]/a')
