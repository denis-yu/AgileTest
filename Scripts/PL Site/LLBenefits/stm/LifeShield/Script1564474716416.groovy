...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'LLBenefits_stm', ('carrierName') : 'LifeShield'], 
...
WebUI.callTestCase(findTestCase('mobileWeb/_include/census_stm'), [('zipcode') : '33186'], FailureHandling.STOP_ON_FAILURE)
