...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'ICA', ('carrierName') : 'AdvantHealth'], 
    FailureHandling.CONTINUE_ON_FAILURE)

GlobalVariable.i = 0

WebUI.callTestCase(findTestCase('mobileWeb/_include/openWebSite'), [('env') : 'https://ica--qa.storefront.mybenefitskeeper.com'], 
    FailureHandling.CONTINUE_ON_FAILURE)
