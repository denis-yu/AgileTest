...
WebUI.callTestCase(findTestCase('mobileWeb/_include/get_screenPath'), [('productLine') : 'TriStar_hbi', ('carrierName') : 'Vitala Care'], 
    FailureHandling.CONTINUE_ON_FAILURE)

GlobalVariable.i = 0

WebUI.callTestCase(findTestCase('mobileWeb/_include/openWebSite'), [('env') : 'https://tristar--qa.storefront.mybenefitskeeper.com'], 
